...
def insertion(
    ...
    """
    Randomly, selects a gene in the chromosome and tries to place it in another position.
    ...
    index_to_remove = random.randrange(number_of_elements)
    ...
    for index in range(number_of_elements):
        # The fitness of the original state is already known.
